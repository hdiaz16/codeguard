...
// portal-cliente tumbara el unmarshal del JSON completo, y con él la capa entera:
...
// el primero: parte del archivo quedó sin mirar. Desde W6 (Q2) cada uno se
// declara como RECIBO parcial de su objetivo: la capa se degrada con el nombre
// del archivo, pero los hallazgos válidos que conviven con él se conservan (en
// portal-cliente un parcial convivía con 45) — recibos y hallazgos son canales
// separados, así que ya no hay que elegir entre decir el hueco y tirar lo
// bueno. Antes de W6 esto era solo un aviso no bloqueante, un stopgap.

...
| **semgrep** | seguridad | Las 161 reglas de la casa del rulepack fijado | ⛔ severidad ERROR |
...
pip con las firmas de PyPI, y los de Go se compilan desde el módulo de
herramientas del repo (`tools/`), con cada dependencia fijada por nuestro
`go.sum` — no con los pisos que declare el upstream del día.
...
| | |
|---|---|
| Rule pack | 2026.08.3 — 161 reglas propias |
...
[Business Source License 1.1](LICENSE). El código fuente está a la vista, y
usarlo —producción incluida— es **gratis** para individuos, organizaciones
educativas o sin fines de lucro, y empresas con menos de 1 millón de USD de
ingresos anuales. Cualquier otro uso en producción requiere una licencia
comercial: escribe a <hfdb16@hotmail.com>. No está permitido ofrecer
CodeGuard, ni un derivado, como producto o servicio que compita con él. Cada
versión publicada se convierte en Apache 2.0 a los cuatro años de publicarse.

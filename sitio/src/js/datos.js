...
export const RULEPACK = "2026.08.2";

/**
 * Reglas propias del rulepack fijado. Contadas, no recordadas:
 *   rulepacks/2026.08.2/semgrep> awk '/^[[:space:]]*-[[:space:]]+id:/{n++} END{print n}' *.yaml
 * → 130
 */
export const REGLAS_PROPIAS = 130;
...
/* ── Los 16 motores de la etapa 2, en el orden en que los devuelve Engines() */
...
export const ETAPAS = [
  ...
  },
  {
    ...
    resumen: "Los 16 motores, en paralelo.",
    detalle:
...
/** Los diecisiete nombres, para la lista de "esto te vigila". */
...
/* ── El cambio que reconstruye la demo ───────────────────────────────────
   ...
   enciende gofmt ni mypy, y enseñar dieciséis capas corriendo sobre él sería
...
export const DEMO = {
  ...
  aplican: ["semgrep", "tsc", "eslint", "trivy", "squawk"],
  // Las once restantes de las dieciséis: no hay Go, Python, C# ni Java aquí.
  noAplican: 11,
  motivoNoAplican: "no hay Go, Python, C# ni Java en este cambio",
};

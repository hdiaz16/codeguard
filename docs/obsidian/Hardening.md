...
18. **API key al Credential Manager** — hoy vive en `HKCU\Environment`, legible por cualquier proceso del usuario. Es la debilidad conocida del punto 13: el entorno del daemon está bien acotado hacia abajo, pero la clave sigue en un sitio que otro programa suyo puede leer
